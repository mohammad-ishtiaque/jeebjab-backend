  ...
  <html>
    ...
    <body>
      <div class="container">
        ...
        <p>Hello, ${data.user}</p>
        <p>Thank you for registering with ${process.env.SERVICE_NAME}. To activate your account, please use the following activation code:</p>
        ...
        <p>Thank you,<br>The ${process.env.SERVICE_NAME} Team</p>
      </div>
      <div class="footer">
        <p>&copy; ${process.env.SERVICE_NAME} - All Rights Reserved.</p>
        <p>
          <a href="https://jeebjab.com/privacy">Privacy Policy</a> |
          <a href="https://jeebjab.com/contact">Contact Support</a>
        </p>
      </div>
    </body>
  </html>
